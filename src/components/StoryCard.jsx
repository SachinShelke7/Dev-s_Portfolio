...
function StoryCard({ name, src, detail, tech, link }) {
    return (
        <div className='w-full px-5 lg:px-0 flex bg-gray-100 shadow-lg mt-28 rounded-lg hover:scale-105 translate transform duration-200'>
            <img 
            ...
            />
            <div className='pl-10'>
            <p className='w-5/6 text-black text-xl font-bold font-serif pt-2'>{name}</p>
